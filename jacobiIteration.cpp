...
// Jacobi Iteration
SquaredMatrix factorizeToDiagMatrix(const SquaredMatrix &matrix) {
...
SquaredMatrix factorizeToLowerTriangularMatrix(const SquaredMatrix &matrix) {
...
SquaredMatrix factorizeToUpperTriangularMatrix(const SquaredMatrix &matrix) {
...
int main() {
    ...
    // Main implementation
    solveSLAThroughJacobi(matrix, vec, error);
